  ...
  Set<Marker> _buildMarkers(List<Event> events) {
    return events.map((event) {
      return Marker(
        ...
        // Both states stay in the crimson family so the map reads as part of
        // the app; the azure selected-state was the last blue left in the UI.
        // Proper fix for a stronger selected state is a custom marker bitmap.
...
[
  ...
  },
  {
    ...
    "stylers": [{"color": "#1D1D26"}]
  },
  {
    "featureType": "road",
    "elementType": "labels.text.fill",
    "stylers": [{"color": "#9A9AA5"}]
  },
  {
