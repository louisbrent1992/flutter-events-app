...
class _AiPlannerScreenState extends State<AiPlannerScreen> {
  ...
  Widget _buildHeroBanner(ThemeData theme, ColorScheme scheme, bool isDark) {
    // Standfirst, not a banner: an eyebrow, a headline and a deck. The
    // planner is a writing surface, so it opens like the top of an article.
    return Column(
      ...
      children: [
        ...
        Text('Plan your night', style: theme.textTheme.displaySmall),
        const SizedBox(height: 8),
        Text(
          "Tell us what you're in the mood for and we'll draft a schedule "
          'you can save as events.',
