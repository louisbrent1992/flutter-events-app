        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Purchase credits for imports and AI planning',
                style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  color: Theme.of(context).colorScheme.onSurfaceVariant,
                  fontSize: AppTypography.responsiveFontSize(
                    context,
          ...
          (context) => AlertDialog(
            ...
            actions: [
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                      isSubscription && trialEligible ? AppPalette.emerald : null,
                  padding: AppDialog.responsiveButtonPadding(context),
                ),
                child: Text(
                  isSubscription
                  ...
                  children: [
                            ...
                            children: [
                              ...
                              if (product.unlimitedUsage) ...[
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: AppPalette.accentPurple.withValues(
                                      alpha: 0.12,
                                    ),
                    ...
                    if (isSubscription && trialEligible) ...[
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: AppPalette.emerald.withValues(alpha: 0.1),
                          borderRadius: BorderRadius.circular(8),
                          border: Border.all(color: AppPalette.emerald, width: 1),
                        ),
                        child: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [
      ...
      child: Column(
        ...
        children: [
          ...
          if (trialEligible) ...[
            Row(
              children: [
                Icon(Icons.celebration, size: 14, color: AppPalette.emerald),
                const SizedBox(width: 6),
                Expanded(
                  child: Text(
                    '7-day free trial included',
