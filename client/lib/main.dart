                    ...
                    builder: (context, dyn, _) {
                      ...
                      return Stack(
                        children: [
                          ...
                          // The App Content
                          //
                          // This wrapper now paints the canvas itself when
                          // there is no remote background. Individual screens
                          // set transparent scaffolds, and the default global
                          // background no longer draws a gradient, so without
                          // this the base colour would fall through to the
                          // window. Stays transparent when a remote image or
                          // gradient background is configured, so it shows.
                          Positioned.fill(
                            child: Scaffold(
                              backgroundColor:
                                  hasBg
